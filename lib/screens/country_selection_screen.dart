...
class CountrySelectionScreen extends StatefulWidget {
  ...
  static const mapPins = [
    ...
    MapPinData(code: 'iceland', position: Offset(0.43, 0.14)),
    MapPinData(code: 'norway', position: Offset(0.54, 0.16)),
    MapPinData(code: 'sweden', position: Offset(0.56, 0.18)),
    MapPinData(code: 'finland', position: Offset(0.59, 0.17)),
    ...
    MapPinData(code: 'portugal', position: Offset(0.472, 0.287)),
    ...
    MapPinData(code: 'czechia', position: Offset(0.545, 0.235)),
    MapPinData(code: 'austria', position: Offset(0.54, 0.255)),
    MapPinData(code: 'slovakia', position: Offset(0.565, 0.255)),
    MapPinData(code: 'slovenia', position: Offset(0.545, 0.288)),
    MapPinData(code: 'hungary', position: Offset(0.555, 0.285)),
    MapPinData(code: 'croatia', position: Offset(0.56, 0.305)),
    MapPinData(code: 'serbia', position: Offset(0.57, 0.315)),
    MapPinData(code: 'bosnia_and_herzegovina', position: Offset(0.552, 0.304)),
    MapPinData(code: 'montenegro', position: Offset(0.554, 0.325)),
    MapPinData(code: 'albania', position: Offset(0.548, 0.341)),
    MapPinData(code: 'belarus', position: Offset(0.58, 0.21)),
    MapPinData(code: 'romania', position: Offset(0.57, 0.25)),
    MapPinData(code: 'bulgaria', position: Offset(0.58, 0.29)),
    MapPinData(code: 'greece', position: Offset(0.56, 0.32)),
    MapPinData(code: 'turkey', position: Offset(0.6, 0.29)),
    MapPinData(code: 'georgia', position: Offset(0.61, 0.25)),
    MapPinData(code: 'armenia', position: Offset(0.62, 0.275)),
    MapPinData(code: 'azerbaijan', position: Offset(0.64, 0.27)),
    MapPinData(code: 'morocco', position: Offset(0.48, 0.34)),
    MapPinData(code: 'algeria', position: Offset(0.52, 0.35)),
    MapPinData(code: 'tunisia', position: Offset(0.55, 0.34)),
    MapPinData(code: 'libya', position: Offset(0.565, 0.35)),
    ...
    MapPinData(code: 'kazakhstan', position: Offset(0.66, 0.27)),
    MapPinData(code: 'uzbekistan', position: Offset(0.67, 0.32)),
    MapPinData(code: 'kyrgyzstan', position: Offset(0.71, 0.32)),
    MapPinData(code: 'tajikistan', position: Offset(0.71, 0.35)),
    MapPinData(code: 'mongolia', position: Offset(0.74, 0.25)),
    MapPinData(code: 'india', position: Offset(0.71, 0.34)),
    MapPinData(code: 'bhutan', position: Offset(0.73, 0.30)),
    MapPinData(code: 'myanmar', position: Offset(0.75, 0.35)),
    MapPinData(code: 'laos', position: Offset(0.79, 0.35)),
    MapPinData(code: 'thailand', position: Offset(0.765, 0.37)),
    MapPinData(code: 'philippines', position: Offset(0.84, 0.36)),
    MapPinData(code: 'vietnam', position: Offset(0.79, 0.42)),
    MapPinData(code: 'sri_lanka', position: Offset(0.72, 0.42)),
    MapPinData(code: 'maldives', position: Offset(0.67, 0.44)),
    MapPinData(code: 'malaysia', position: Offset(0.77, 0.40)),
    MapPinData(code: 'singapore', position: Offset(0.775, 0.415)),
    MapPinData(code: 'indonesia', position: Offset(0.84, 0.49)),
    MapPinData(code: 'papua_new_guinea', position: Offset(0.90, 0.50)),
    ...
    MapPinData(code: 'cuba', position: Offset(0.27, 0.35)),
    MapPinData(code: 'haiti', position: Offset(0.30, 0.36)),
    MapPinData(code: 'guatemala', position: Offset(0.235, 0.40)),
    MapPinData(code: 'el_salvador', position: Offset(0.245, 0.41)),
    MapPinData(code: 'nicaragua', position: Offset(0.25, 0.42)),
    MapPinData(code: 'panama', position: Offset(0.255, 0.43)),
    MapPinData(code: 'colombia', position: Offset(0.31, 0.47)),
    MapPinData(code: 'ecuador', position: Offset(0.29, 0.49)),
    MapPinData(code: 'peru', position: Offset(0.30, 0.51)),
    MapPinData(code: 'chile', position: Offset(0.295, 0.62)),
    MapPinData(code: 'bolivia', position: Offset(0.33, 0.56)),
    MapPinData(code: 'paraguay', position: Offset(0.35, 0.58)),
