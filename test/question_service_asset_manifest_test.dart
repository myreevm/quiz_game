...
void main() {
  ...
  group('QuestionService real asset coverage', () {
    ...
    test(
        'AssetManifest includes Albania, Algeria, Argentina, Armenia, Australia, Austria, Azerbaijan, Belarus, Bhutan, Bolivia, Bosnia and Herzegovina, Brazil, Bulgaria, Canada, Chile, China, Colombia, Croatia, Cuba, Czechia, Ecuador, El Salvador, Egypt, Finland, France, Georgia, Germany, Greece, Guatemala, Haiti, Hungary, India, Iceland, Indonesia, Italy, Japan, Kazakhstan, Kyrgyzstan, Laos, Libya, Malaysia, Maldives, Mexico, Mongolia, Montenegro, Morocco, Myanmar, New Zealand, Nicaragua, Norway, Panama, Papua New Guinea, Paraguay, Peru, Philippines, Poland, Portugal, Romania, Russia, Serbia, Singapore, Slovakia, Slovenia, Sri Lanka, South Africa, South Korea, Spain, Sweden, Switzerland, Tajikistan, Thailand, Tunisia, Turkey, UK, USA, Uzbekistan, and Vietnam language files',
        () async {
      final manifestBin = File('build/unit_test_assets/AssetManifest.bin');
      expect(manifestBin.existsSync(), isTrue);
